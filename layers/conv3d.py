...
class Conv3d(Layer):
    ...
    def __init__(self, x, filter_shape, bias=True, stride=1, pad_size=0, pad_mode='CONSTANT',
        ...
        filter_shape : list of int
            Shape of convolutional filter. [filter_depth, filter_height, filter_width, chn_in]
            or [filter_depth, filter_height, filter_width, chn_in, chn_out]
        bias : bool
            Whether to add bias.
        stride : int
            Stride size.
