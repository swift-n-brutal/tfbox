...
class Deconv2d(Layer):
    ...
    def __init__(self, x, filter_shape, bias=True, stride=1, pad_size=-1, pad_type='CONSTANT',
        ...
        filter_shape : list of int
            Shape of convolutional filter. [filter_height, filter_width, chn_out]
            or [filter_height, filter_width, chn_out, chn_in]. As this layer is
        ...
        with tf.variable_scope(name):
            ...
            # TODO Add pad_size feature in conv2d_transpose in future
            if pad_size > 0:
